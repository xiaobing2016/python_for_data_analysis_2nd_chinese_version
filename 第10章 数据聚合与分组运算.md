...
```
## 取得分组数据
获得分组那列key的值，使用get_group
```
In[] :grouped.get_group('a')
Output[]:

 	key1 	key2 	data1 	data2
0 	a 	one 	-1.401016 	-1.747666
1 	a 	two 	-0.066140 	-0.651159
4 	a 	one 	0.588634 	-0.781428

In: grouped.get_group('b')
key1 	key2 	data1 	data2
2 	b 	one 	-0.100001 	0.913527
3 	b 	two 	0.117276 	0.334086
